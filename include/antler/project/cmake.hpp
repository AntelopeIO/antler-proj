...
public:
   ...
   cmake(const project& proj)
      : proj(&proj), base_path(proj.path() / build_dir_name), base_lists(base_path), apps_lists(base_path / apps_dir_name), libs_lists(base_path / libs_dir_name), tests_lists(base_path / tests_dir_name) {
   ...
   cmake(cmake&& o)
      : proj(o.proj), base_path(std::move(o.base_path)), base_lists(std::move(o.base_lists)), apps_lists(std::move(o.apps_lists)), libs_lists(std::move(o.libs_lists)), tests_lists(std::move(o.tests_lists)) {
