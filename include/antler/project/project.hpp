...
public:
   ...
   constexpr static inline std::string_view comment_preamble =
   ...
   project(const system::fs::path& path, std::string_view name, std::string_view version_raw)
      ...
      system::debug_log("project(const system::fs::path&, std::string_view, std::string_view) called with path : {0}, name : {1}, version : {2}", path.string(), name, version_raw);
   }
